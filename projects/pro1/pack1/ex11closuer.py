# Closure : Scope에 제약을 받지 않는 변수들을 포함하고 있는 코드 블록이다.
...
li = [lambda x, y : x + y, lambda a, b: a * b]
print(li[0](3, 4))
print(li[1](3, 4))
...
print(list(filter(lambda a:a % 2, range(10))))  # a % 2 = 0(False) | 1(True)
