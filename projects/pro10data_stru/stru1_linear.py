...
print('영희가 빠진 후 줄 상태 :', line)
print()

# 앞사람부터 놀이기구 타기 - 첫번째 자료부터 빠져나감. 뒷자료는 앞으로 이동
first_person = line.pop(0)  # pop(0) : 맨 왼쪽값 추출, pop() : 맨 오른쪽값 추출
...
# 중간에 새로운 사람이 삽입 : '철수','영희','민수'에서 지수를 민수 앞으로 삽입
# index 2 위치에 지수 삽입 - 공간확보 -> 2 이후 뒤로 한칸씩 이동 -> 값 대입
line.append(None)   # 공간 확보(맨 뒤)
