...
obj = pd.Series([3, 7, -5, 4])  # List -> Series
# obj = pd.Series([3, 7, -5, '4'])  # Object -> Series
# obj = pd.Series([3, 7, -5, '사'])  # Object -> Series   # 요소값은 object type
# obj = pd.Series((3, 7, -5, 4))  # Tuple -> Series

# obj = pd.Series({3, 7, -5, 4})  # Set -> Series  # TypeError: 'set' type is unordered
print(obj, type(obj))

obj2 = pd.Series([3, 7, -5, 4], index=['a', 'b', 'c', 'd'])
print(obj2)
print(obj2.sum(), ' ', np.sum(obj2), ' ', sum(obj2))
# pandas는 연산에 관련된 numpy의 내장함수를 가져다쓸 수 있다.
print(obj2.std())
...
# print(obj2[2])        # Error
print(obj2.iloc[2])     # 인덱스 사용
print(obj2[1:4])        

# print(obj2[[2, 1]])   # Error
print(obj2.iloc[[2, 1]])
...
print(val)
frame2['tel'] = val     # 완전히 덮어쓰기
print(frame2)           # 위에서 준 데이터 지워지고 val로 갈아끼워짐
...
print('----------------')
print(frame2)
print(frame2.sort_index(axis=0, ascending=False))   # 행단위 내림차순
print(frame2.sort_index(axis=1, ascending=True))   # 열단위 오름차순
