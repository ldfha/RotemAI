...
print(stats.shapiro(x2).pvalue)     # 0.10214157305396593

# 대응 표본 t검정
print(stats.ttest_rel(x1, x2))
# statistic=-3.0031027083, pvalue=0.003383791, df=99
# 해석 : pvalue 0.003383791 < alpha 0.05 이므로 귀무가설 기각.
# 특강이 시험점수에 영항을 주었다. 라는 의견을 받아들임