...
print('chi2 : ', chi2)  # 18.910915
print('p : ', p)    # 0.00081825728
print('dof : ', dof)    # 자유도 : 4
print('expected : ', expected)  # 예측된 기대도수

# 판정1 : 유의수준 0.05 > p:0.00081825728   이므로 귀무가설이 기각
# 교육수준과 흡연율 간에 관계가 있다. smoke.csv(수집자료)는 우연히 발생된 자료가 아니다.

# 판정2 : chi2:18.910915, dof:4, critical value:9.49
# chi2값이 임계치 우측에 있으므로 귀무가설이 기각되고 대립가설이 채택
...
# 귀무(H0) : 성별과 음료 선호는 서로 연관이 없다.
# 대립(H1) : 성별과 음료 선호는 서로 연관이 있다.
...
print('chi2 : ', chi2)  # 11.375
print('p : ', p)    # 0.003388052
print('dof : ', dof)    # 자유도 : 2
print('expected : ', expected)  # 예측된 기대도수
