...
result = stats.ttest_1samp(one_sample, popmean=177) # 데이터, 예상 평균
print(result)
# statistic = -0.2213944457, pvalue = 0.83562821, df = 4
# 유의수준 0.05 < pvalue 이므로 귀무가설 채택

print()
result2 = stats.ttest_1samp(one_sample, popmean=165)
print(result2)
# statistic = 3.18467395, pvalue = 0.033385667, df = 4
# 유의수준 0.05 > pvalue 이므로귀무가설 기각
