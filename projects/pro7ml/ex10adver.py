...
# 잔차(Residual):실제 관측값과 모델이 예측한 값의 차이를 의미
...
print('잔차평균값 :', np.mean(residual[:5]))    # 1.6738829920227818
...
# 통계량 : 0.9905306561484947, p-value : 0.21332551436716007 > 0.05 이므로 정규성 만족
...
# 독립젼수와 종속변수 간에 선형형태로 적절하게 모델링 되었는지 검정
...
# 시각화
fig = sm.graphics.influence_plot(lm, alpha=0.05, criterion="cook")    # 원이 클수록 이상치 의심
plt.show()
