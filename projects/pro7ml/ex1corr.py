...
print('x, y의 공분산 :', np.cov(x, y)[0, 1])    # 5.22222

x2 = [80,30,60,60,90,40,30,90,30,40]
y2 = [6,2,4,6,9,5,1,8,4,5]
print('x2, y2의 공분산 :', np.cov(x2, y2)[0, 1])    # 52.2222
plt.plot(x2, y2, 'o')
plt.show()
...
# 공분산을 표준화해서 -1 0 1 범위로 만든 것이 상관계수(r)이다.
print('x, y의 상관계수 :', np.corrcoef(x, y))   # 피어슨 상관계수
print('x, y의 상관계수 :', np.corrcoef(x, y)[0, 1])     # 0.86
print('x2, y2의 상관계수 :', np.corrcoef(x2, y2)[0, 1]) # 0.86
