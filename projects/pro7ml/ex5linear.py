...
print('\n방법2 : Linear regression 사용. model 생성 O')
...
# 예측값 확인
y_newpred = fit_model.predict([[0]])  # [100.]
print('예측값 :', y_newpred)
...
print(model2.params['Intercept'])    # 99.99999999999997
# 예측값 확인
new_df = pd.DataFrame({'x1':[-1.70073563, -0.67794537]})    # 기존자료 검증
print('예측값 :', model2.predict(new_df))   # 39.341308
new_df2 = pd.DataFrame({'x1':[0.1234, 0.2345]})  # 새로운 자료 검증
print('예측값2 :', model2.predict(new_df2)) # 120.981725