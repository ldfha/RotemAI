...
print('\n 로짓(logit) 변환된(가정) 값으로 시그모이드 함수 통과 후 그 결과 시각화')
...
print("z[:3] :", np.round(z[:3], 3))    # [-17.  -16.388  -15.776]
print("p[:3] :", p[:3])                 # [4.1399e-08 7.6363e-08 1.4085e-07]
