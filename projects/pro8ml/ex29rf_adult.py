...
# train / test split
train_x, test_x, train_y, test_y = train_test_split(x, y, test_size=0.3, random_state=12, stratify=y)   # stratify=y : class 비율 유지
...
grid = GridSearchCV(
    estimator=pipeline,       # 전체 파이프라인 사용
