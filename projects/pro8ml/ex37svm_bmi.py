# BMI(Body Mass Index)는 체질량지수로, 몸무게(kg)를 키의 제곱)으로 나눈 값. 
...
print(df.head(3), df.shape)     # (50000, 3)
print(df.info())
...
x_train, x_test, y_train, y_test = train_test_split(wh, label, random_state=12, test_size=0.3)
...
print('sc_score :', sc_score)   # 0.9694
