...
print('최적의 k값 :', best_k)   # test acc가 가장 높은 지점 : 3
...
print('final_model 분류 정확도 :', accuracy_score(y_test, y_pred))      # 0.97368
print('분류 리포트\n', classification_report(y_test, y_pred))
print('Confussion matrix (혼동 행렬)\n', confusion_matrix(y_test, y_pred))
